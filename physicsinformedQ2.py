...
Original file is located at
    https://colab.research.google.com/drive/1YFzRxpIfTJKeQXHHLJA3WeAyoYbp3910
"""
...
class PhysicsInformedBarModel:
    ...
    def __init__(self, E, I, L, u0, u1, dist_load):
        ...
        self.model = utilities.build_model(1,[45,45],1)
    ...
    def costFunction(self, x, u_pred):
        ...
        differential_equation_loss = utilities.get_derivative(utilities.get_derivative(self.E(x)*self.I(x)*utilities.get_derivative(utilities.get_derivative(u_pred,x,1),x,1),x,1),x,1) + self.dist_load(x)
        ...
        u_pred_derivative = utilities.get_derivative(u_pred,x,1)
        boundary_condition_loss += (u_pred_derivative[0] - self.u1[0]) ** 2
        boundary_condition_loss += (u_pred_derivative[-1] - self.u1[1]) ** 2
